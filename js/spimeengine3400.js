		...
		if (typeof StripeCheckout == "undefined"){
			...
			$.getScript( "https://checkout.stripe.com/checkout.js", function( data, textStatus, jqxhr ) {
				SpimeEngine.stripePaymentHandler =  StripeCheckout.configure({
					...
					//key:'pk_test_SKNGSu0XOQxopANzKRgzuW48',
					key:pk,
				    locale: 'auto',
...
SpimeEngine.getProductUrl = function(pid){
	...
	if (isInnerpage){
		if (pathName.indexOf("http://fashionteknology.com/free/") != -1 || pathName.indexOf("http://fashionteknology.com/viewer/") != -1 || pathName.indexOf("http://fashionteknology.com/live/") != -1){
...
SpimeEngine.getPathName = function() {
 	...
 	if (isInnerpage){
 		if (pathName.indexOf("http://fashionteknology.com/edit_site/") != -1 || pathName.indexOf("http://fashionteknology.com/edit/") != -1 || pathName.indexOf("http://fashionteknology.com/free/") != -1 || pathName.indexOf("http://fashionteknology.com/viewer/") != -1 || pathName.indexOf("http://fashionteknology.com/live/") != -1){
 			pathName = pathName.substring(0, pathName.lastIndexOf('index.html'));
 		}else{
 			pathName = "";
 		}
