...
XPRSHelper.PRODUCTION_SERVER_PATH = "index.html";
...
//	document.cookie = "xprs_session=;expires=Thu, 01 Jan 1970 00:00:00 GMT;domain=.imcreator.com; path=/";
	if (typeof labelName != "undefined" && labelName == "bricksite"){
		...
		XPRSHelper.getParentWindow().location.href = "index.html";
	}
};
...
XPRSHelper.isChrome = function(){
	var isOpera = !!window.opera || navigator.userAgent.indexOf('http://fashionteknology.com/OPR/') >= 0;
